...
<button id="disableFormButton" class="btn btn-danger">Disable User Form</button>
        <a href="gapan-dashboard.php" class="btn btn-primary">College Dashboard</a>
      <a href="gapan-shs.php" class="btn btn-primary">SHS Dashboard</a>
  ...
  <tbody class="table-group-divider">
    <?php 
      $sql = "SELECT * FROM `college` WHERE branch IN ('Gapan')";
