...
<button id="disableFormButton" class="btn btn-danger">Disable User Form</button>
      <a href="sanjose-dashboard.php" class="btn btn-primary">College Dashboard</a>
      <a href="sanjose-shs.php" class="btn btn-primary">SHS Dashboard</a>
  ...
  <tbody class="table-group-divider">
    <?php 
      $sql = "SELECT * FROM `college` WHERE branch IN ('San Jose')";
