...
if(isset($_SESSION['id']) && isset($_SESSION['firstname'])
 ...
 && isset($_SESSION['Classified'])
 && isset($_SESSION['year_status'])
 && isset($_SESSION['course'])
 && isset($_SESSION['enrollment_status'])
 && isset($_SESSION['student_number'])
 ){
...
<div class="con">
  ...
  <tr>
      ...
      <td colspan="2"><?php echo $_SESSION['student_number']; ?></td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="2"><?php echo $_SESSION['Classified']; ?></td>
    </tr>

    <tr>
      <th scope="row">Year Status</th>
      <td colspan="2"><?php echo $_SESSION['year_status']; ?></td>
    </tr>

    <tr>
      <th scope="row">Course</th>
      <td colspan="2"><?php echo $_SESSION['course']; ?></td>
    </tr>

    <tr>
      <th scope="row">Enrollment Status</th>
      <td colspan="2"><?php echo $_SESSION['enrollment_status']; ?></td>
    </tr>
